...
function AdminDashboard({ onLogout }) {
  ...
  const renderDashboard = () => (
    <div className="dashboard-container">
      ...
      <Row className="g-4 mb-4">
        <Col md={6}>
          <Card className="gateway-card"><Card.Body>
            <h5>Today's Entries</h5><h2>{stats.todayEntries}</h2>
          </Card.Body></Card>
        </Col>
        <Col md={6}>
          <Card className="gateway-card"><Card.Body>
            <h5>Today's Exits</h5><h2>{stats.todayExits}</h2>
          </Card.Body></Card>
        </Col>
      </Row>
      ...
      <Row className="g-4">
        ...
        <Col lg={6}>
          <Card className="analytics-card">
            <Card.Body>
              <h6 style={{ fontWeight:700, fontSize:15, marginBottom:2 }}>Overall Status Distribution</h6>
              <p style={{ fontSize:12, color:'#aaa', marginBottom:20 }}>Total attendance status breakdown</p>
        ...
        <Col lg={6}>
          <Card className="analytics-card">
            <Card.Body>
              <h6 style={{ fontWeight:700, fontSize:15, marginBottom:2 }}>Department-wise Attendance</h6>
              <p style={{ fontSize:12, color:'#aaa', marginBottom:16 }}>Attendance breakdown by department</p>
